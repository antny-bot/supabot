...
import {
  AlertTriangle, Check, CheckCircle, ChevronLeft, ChevronRight, Clock,
  Download, RefreshCw, ShoppingCart, Trash2, TrendingUp, Upload, UserCheck, Users,
} from 'lucide-react'
...
import type { ConfigItem, DashboardData, DashboardStats } from '../types'
...
const DASHBOARD_STAT_CONFIG: { key: keyof DashboardStats; label: string; Icon: React.ElementType; bg: string }[] = [
  { key: 'users_total',  label: '전체 사용자', Icon: Users,         bg: 'bg-primary-500' },
  { key: 'users_active', label: '활성 사용자', Icon: UserCheck,     bg: 'bg-emerald-500' },
  { key: 'users_pending', label: '승인 대기',  Icon: Clock,         bg: 'bg-amber-500' },
      ...
      {data && (
        <>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
            {DASHBOARD_STAT_CONFIG.map(({ key, label, Icon, bg }, index) => (
